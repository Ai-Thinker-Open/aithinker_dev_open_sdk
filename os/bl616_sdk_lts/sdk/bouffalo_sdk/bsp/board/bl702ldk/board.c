...
static void system_clock_init(void)
{
    ...
    GLB_Set_MTimer_CLK(1, GLB_MTIMER_CLK_XCLK, 31);
...
void board_pwm_gpio_init()
{
    ...
    bflb_gpio_init(gpio, GPIO_PIN_8, GPIO_FUNC_PWM0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1);
    bflb_gpio_init(gpio, GPIO_PIN_9, GPIO_FUNC_PWM0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_1);
}
