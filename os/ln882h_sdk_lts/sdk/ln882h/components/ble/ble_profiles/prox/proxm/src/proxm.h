...
struct proxm_env_tag
{
    ...
    struct proxm_cnx_env *p_env[PROXM_IDX_MAX];
 ...
 *
 * @param p_proxm_env   Proximity Monitor Role task environment
 ...
 *
 * @param[in] p_proxm_env Client environment.
...
/**
 ****************************************************************************************
 * @brief Send an PROXM_CMP_EVT message to a requester.
 *
 * @param[in] p_proxm_env   Proximity Monitor environment variable
 * @param[in] conidx        Connection index
