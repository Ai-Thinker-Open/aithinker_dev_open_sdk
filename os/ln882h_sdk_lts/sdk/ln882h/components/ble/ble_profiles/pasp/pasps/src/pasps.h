...
#define PASPS_ENABLE_NTF(conidx, idx_env, flag)     (idx_env->p_env[conidx]->ntf_state |= flag)

#define PASPS_DISABLE_NTF(conidx, idx_env, flag)    (idx_env->p_env[conidx]->ntf_state &= ~flag)
...
struct pasps_env_tag
{
    ...
    struct pasps_cnx_env *p_env[BLE_CONNECTION_MAX];
