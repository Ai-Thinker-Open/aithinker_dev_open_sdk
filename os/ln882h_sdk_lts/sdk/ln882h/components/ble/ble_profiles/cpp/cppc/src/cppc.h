...
enum cppc_code
{
    ...
    /// Read CP Control Point Client Char. Configuration Descriptor
...
struct cppc_env_tag
{
    ...
    struct cppc_cnx_env *p_env[CPPC_IDX_MAX];
 ...
 * @param[in] p_param Pointer to the parameters of the message.
 * @param[out] p_req packed message
 * @param[out] p_status status of the operation
 * @return length
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
uint8_t cppc_unpack_ctln_pt_ind (uint8_t conidx, struct gattc_event_ind const *p_param,struct cppc_env_tag *p_cppc_env);
