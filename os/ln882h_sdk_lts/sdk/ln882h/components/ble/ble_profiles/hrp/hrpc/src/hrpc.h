...
struct hrpc_env_tag
{
    ...
    struct hrpc_cnx_env *p_env[HRPC_IDX_MAX];
 ...
 *
 * @param p_hrpc_env    Heart Rate Profile Client Role task environment
 ...
 *
 * @param[out] p_meas_val   Pointer to Heart Rate measurement structure destination
 * @param[in]  p_packed_hr  Pointer of the packed data of Heart Rate Measurement
 *                          information
...
/**
 ****************************************************************************************
 * @brief Send an HRPC_CMP_EVT message to a requester.
 *
 * @param[in] p_hrpc_env    HRP Client environment variable
