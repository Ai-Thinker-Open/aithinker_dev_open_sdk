...
struct cscpc_env_tag
{
    ...
    struct cscpc_cnx_env *p_env[CSCPC_IDX_MAX];
...
/**
 ****************************************************************************************
 * @brief Send CSCP ATT DB discovery results to CSCPC host.
 *
 * @param p_cscpc_env   CSC Profile Client Role task environment
 ...
 *
 * @param[in] p_cscpc_env    CSCP Client environment variable
