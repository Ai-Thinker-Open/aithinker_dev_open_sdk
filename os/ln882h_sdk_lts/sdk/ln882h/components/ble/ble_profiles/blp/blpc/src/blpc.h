...
struct blpc_env_tag
{
    ...
    struct blpc_cnx_env *p_env[BLPC_IDX_MAX];
 ...
 *
 * @param p_blpc_env    Blood Pressure Profile Client Role task environment
 ...
 * @param[in] p_packed_bp Pointer of the packed data of Blood Pressure Measurement information
 ****************************************************************************************
 */
 ...
 *
 * @param[in] p_blpc_env    BLP Client environment variable
