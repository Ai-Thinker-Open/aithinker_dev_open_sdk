 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ void co_bswap(uint8_t* p_val_out, const uint8_t* p_val_in, uint16_t len)
{
    while (len > 0)
    {
        len--;
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_bswap32(uint32_t val32)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_bswap24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint16_t co_bswap16(uint16_t val16)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_htonl(uint32_t hostlong)
{
    #if (!CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_hton24(uint32_t host24)
{
    #if (!CPU_LE)
        return host24;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint16_t co_htons(uint16_t hostshort)
{
    #if (!CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_ntohl(uint32_t netlong)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_ntoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint16_t co_ntohs(uint16_t netshort)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_htob24(uint32_t val24)
{
    #if (CPU_LE)
        return val24;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_htobl(uint32_t hostlong)
{
    #if (CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint16_t co_htobs(uint16_t hostshort)
{
    #if (CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_btoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint32_t co_btohl(uint32_t btlong)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ uint16_t co_btohs(uint16_t btshort)
{
