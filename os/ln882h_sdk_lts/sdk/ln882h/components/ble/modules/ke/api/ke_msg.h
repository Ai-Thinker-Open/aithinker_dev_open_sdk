...
//#include "ln821x.h"        // compiler definition
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ struct ke_msg * ke_param2msg(void const *param_ptr)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE__ void * ke_msg2param(struct ke_msg const *msg)
{
