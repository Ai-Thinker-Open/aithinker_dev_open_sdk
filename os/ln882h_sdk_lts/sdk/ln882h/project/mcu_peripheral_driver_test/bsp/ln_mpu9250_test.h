...
uint8_t ln_mpu_waitfor_ready(uint8_t devaddr);
uint8_t ln_mpu_write_byte(uint8_t devaddr,uint8_t reg,uint8_t data);
uint8_t ln_mpu_read_byte(uint8_t devaddr,uint8_t reg);
