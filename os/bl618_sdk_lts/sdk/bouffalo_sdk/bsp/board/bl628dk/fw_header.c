...
__attribute__((section(".fw_header"))) struct bootheader_t fw_header = {
    ...
    .clk_cfg.cfg.xtal_type = 0x04,      /*!< 0:None,1:24M,2:32M,3:38.4M,4:40M,5:26M,6:RC32M,7:Auto */
    .clk_cfg.cfg.wifipll_pu=0x01,
    .clk_cfg.cfg.cpupll_pu=0x01,
    .clk_cfg.cfg.mcu_clk=0x05,         /*!< 0:RC32M,1:XTAL,2:CPUPLL_DIV2,3:CPUPLL_DIV3,4:WIFIPLL_240M,5:WIFIPLL_320M */
    .clk_cfg.cfg.mcu_clk_div=0x00,
    .clk_cfg.cfg.mcu_bclk_div=0x03,
    .clk_cfg.cfg.wlp2_mcu_clk=0x02,    /*!< 0:RC32M,1:XTAL,2:CPUPLL_DIV1,3:CPUPLL_DIV2,4:CPUPLL_DIV3 */
    .clk_cfg.cfg.wlp2_mcu_clk_div=0x00,
    .clk_cfg.cfg.wlp2_mcu_bclk_div=0x02,
    .clk_cfg.cfg.wlp1_root_clk=0x03,   /*!< 0:RC32M,1:XTAL,2:CPUPLL_DIV3,3:CPUPLL_DIV2,4:WIFIPLL_240M */
    .clk_cfg.cfg.wlp1_root_bclk_div=0x01,
    .clk_cfg.cfg.flash_clk_type=0x01,  /*!< 0:WIFIPLL_120M,1:XTAL,2:MUXPLL_80M,3:BCLK,4:WIFIPLL_96M */
...
# 3 : SF_CTRL_WRAP_LEN_64, 9 : SF_CTRL_WRAP_LEN_4096
    ...
    .cpu_cfg[0].rsvd1 = 0x80000000,   /* rsvd */
    ...
    .cpu_cfg[1].rsvd1 = 0x00000000,   /* rsvd */
