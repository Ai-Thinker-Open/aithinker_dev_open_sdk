...
#define AIIO_portMAX_DELAY      portMAX_DELAY 
...
#define     __AIIO_GPIO_NUM_MAX         (37)   /*!< max gpio */

#define     __BOOT_PORT_  __AIIO_GPIO_B   //Actual invalidity
#define     __BOOT_NUM_  __AIIO_GPIO_NUM_36
/* LED IO differs per board variant. Selected by the build-injected board macro
 * (AIIO_BOARD_BL616CL_48 / AIIO_BOARD_BL616CL_32). Same platform, same code, only pins differ. */
#if defined(AIIO_BOARD_BL616CL_32)
/* TODO(bl616cl-32): replace with the real GPIO numbers of the 32-pin board */
#define     __FACTORY_LED_RED_NUM_      __AIIO_GPIO_NUM_19
#define     __FACTORY_LED_GREEN_NUM_    __AIIO_GPIO_NUM_22
#define     __FACTORY_LED_BLUE_NUM_     __AIIO_GPIO_NUM_18
#define     __FACTORY_LED_White_NUM_    __AIIO_GPIO_NUM_13
#define     __FACTORY_LED_Warm_NUM_     __AIIO_GPIO_NUM_23
#else  /* default: bl616cl-48 / bl616cl */
#define     __FACTORY_LED_RED_NUM_      __AIIO_GPIO_NUM_14
#define     __FACTORY_LED_GREEN_NUM_    __AIIO_GPIO_NUM_15
#define     __FACTORY_LED_BLUE_NUM_     __AIIO_GPIO_NUM_16
#define     __FACTORY_LED_White_NUM_    __AIIO_GPIO_NUM_27
#define     __FACTORY_LED_Warm_NUM_     __AIIO_GPIO_NUM_28
#endif
/* UART SPEC */
