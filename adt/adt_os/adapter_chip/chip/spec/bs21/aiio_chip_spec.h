...
#else
#define     __AIIO_OS_PRIORITY_DEFAULT  (24)
#define     __AIIO_OS_PRIORITY_FREE  (__AIIO_OS_PRIORITY_DEFAULT-1)
#endif

#define AIIO_portMAX_DELAY      1000 
...
#define     __AIIO_UART1_TX             (19)
#define     __AIIO_UART1_RX_P
#define     __AIIO_UART1_RX             (20)

// 用于确定是否使能入口函数
#define AIIO_NO_SETBUF

/* RTOS SPEC */
// 入口函数不使能，作为任务调用
#define     __MAIN_ENTRY()          void axk_app_main(void)
