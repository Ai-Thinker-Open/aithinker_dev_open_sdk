...
#define __AIIO_GPIO_NUM_MAX             (32)     /*!< max gpio */

#define     __BOOT_PORT_  __AIIO_GPIO_B   //PB5
#define     __BOOT_NUM_  __AIIO_GPIO_NUM_5   //PB5
#define     __FACTORY_LED_RED_NUM_      __AIIO_GPIO_NUM_17
#define     __FACTORY_LED_GREEN_NUM_    __AIIO_GPIO_NUM_18
#define     __FACTORY_LED_BLUE_NUM_     __AIIO_GPIO_NUM_19
...
#define     __AIIO_UART0_TX             __AIIO_GPIO_NUM_5
#define     __AIIO_UART0_RX_P           __AIIO_GPIO_B
#define     __AIIO_UART0_RX             __AIIO_GPIO_NUM_4

/* UART SPEC */
#define     __AIIO_UART1_TX_P           __AIIO_GPIO_B
#define     __AIIO_UART1_TX             __AIIO_GPIO_NUM_31
#define     __AIIO_UART1_RX_P           __AIIO_GPIO_B
#define     __AIIO_UART1_RX             __AIIO_GPIO_NUM_30
