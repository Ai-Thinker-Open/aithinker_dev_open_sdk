...
#define     __FACTORY_LED_RED_NUM_      __AIIO_GPIO_NUM_1
#define     __FACTORY_LED_GREEN_NUM_    __AIIO_GPIO_NUM_30
#define     __FACTORY_LED_BLUE_NUM_     __AIIO_GPIO_NUM_0
#define     __FACTORY_LED_White_NUM_    __AIIO_GPIO_NUM_29
#define     __FACTORY_LED_Warm_NUM_     __AIIO_GPIO_NUM_27
/* UART SPEC */
...
/* RTOS SPEC */
#define     __MAIN_ENTRY()          void bfl_main(void)
