...
#define __AIIO_GPIO_NUM_MAX             (48)     /*!< max gpio */

#define     __BOOT_PORT_  __AIIO_GPIO_A   //pa9
...
#define     __AIIO_UART0_TX_P           __AIIO_GPIO_A
#define     __AIIO_UART0_TX             __AIIO_GPIO_NUM_7
#define     __AIIO_UART0_RX_P           __AIIO_GPIO_A
#define     __AIIO_UART0_RX             __AIIO_GPIO_NUM_8

/* UART SPEC */
#define     __AIIO_UART1_TX_P           __AIIO_GPIO_B
#define     __AIIO_UART1_TX             __AIIO_GPIO_NUM_1
#define     __AIIO_UART1_RX_P           __AIIO_GPIO_B
#define     __AIIO_UART1_RX             __AIIO_GPIO_NUM_2
