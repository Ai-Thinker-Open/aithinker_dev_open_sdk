...
int32_t aiio_uart_param_check(aiio_uart_config_t uart)
{
    ...
    switch (uart.uart_tx_pin)
    {
        case __AIIO_GPIO_NUM_5:
        case __AIIO_GPIO_NUM_31:
            break;
        default:
    ...
    switch (uart.uart_rx_pin)
    {
        case __AIIO_GPIO_NUM_4:
        case __AIIO_GPIO_NUM_30:
            break;
        default:
            return AIIO_UART_PIN_NOT_SUPPORT;
    }
...
int32_t aiio_uart_init(aiio_uart_config_t uart)
{
    ...
    switch (uart.uart_tx_pin)
    {
        case __AIIO_GPIO_NUM_5:
            ...
            break;
        case __AIIO_GPIO_NUM_31:
            tx_pin = RTL8711_PIN_CALCULATE(__AIIO_GPIO_B, __AIIO_GPIO_NUM_31);
            break;
        default:
            return AIIO_UART_PIN_NOT_SUPPORT;
    }
    switch (uart.uart_rx_pin)
    {
        case __AIIO_GPIO_NUM_4:
            ...
            break;
        case __AIIO_GPIO_NUM_30:
            rx_pin = RTL8711_PIN_CALCULATE(__AIIO_GPIO_B, __AIIO_GPIO_NUM_30);
            break;
        default:
            return AIIO_UART_PIN_NOT_SUPPORT;
    }
