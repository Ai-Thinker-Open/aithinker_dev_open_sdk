...
/* bl616cl does not have GLB_GPIO_Cfg_Type / GLB_GPIO_Type (old-style API).
 * GPIO wakeup is not supported on bl616cl via this path. */
#if 0
...
#endif /* 0 - GPIO wakeup not supported on bl616cl */
