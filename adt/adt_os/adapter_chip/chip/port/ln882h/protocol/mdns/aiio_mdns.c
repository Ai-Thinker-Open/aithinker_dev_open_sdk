...
//#include <utils_sha256.h> //ln882h no such file
#include <lwip/apps/mdns_priv.h>
#include <lwip/apps/mdns.h>
#include <lwip/netif.h>
#include <netif/ethernetif.h>
//#include "mdns_server.h"  //ln882h no such file
//#include <wifi_mgmr_ext.h>  //ln882h no such file
#include <lwip/netifapi.h>
//#include <hal_sys.h>  //ln882h no such file
...
aiio_ret_t aiio_mdns_init(aiio_mdns_config_t config)
{
    ...
    netif = NULL;
    netif = netdev_get_netif(NETIF_IDX_STA);
    if (netif == NULL)
    {
