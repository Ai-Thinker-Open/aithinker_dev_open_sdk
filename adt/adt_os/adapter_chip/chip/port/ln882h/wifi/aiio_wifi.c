...
static aiio_input_event_t aiio_event = {0};
...
aiio_err_t aiio_wifi_set_config(aiio_wifi_port_t port, aiio_wifi_config_t *conf)
{
    ...
    memset(&wifi_config,0,sizeof(aiio_wifi_config_t));
...
{
    extern int wifi_mgmr_set_hostname(char *hostname);
