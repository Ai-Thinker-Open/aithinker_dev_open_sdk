 ...
 * @see
 */
CHIP_API aiio_ret_t aiio_mdns_init(aiio_mdns_config_t config);
 ...
 * @see
 */
CHIP_API aiio_ret_t aiio_mdns_deinit(void);
 ...
 * @see
 */
CHIP_API aiio_ret_t aiio_mdns_update_txt(char *service_type, uint16_t protocol, aiio_mdns_txt_item_t txt[], uint8_t num_items);
