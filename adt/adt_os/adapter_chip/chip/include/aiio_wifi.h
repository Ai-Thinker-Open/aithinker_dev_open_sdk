...
#define AIIO_WIFI_IDENTITY_SIZE   (65)
#define PMK_LEN (65)
#define MAC_LEN (6)
...
typedef enum {
    ...
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WEP_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WEP_SHARED,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPS,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_TKIP_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_TKIP_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_TKIP_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_TKIP_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_AES_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_AES_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_MIXED_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_WPA2_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_AES_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_AES_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_MIXED_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA_MIXED_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_MIXED_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_WPA3_MIXED,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_AES_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_AES_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_AES_CMAC,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_TKIP_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA2_TKIP_ENTERPRISE,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA3_AES_PSK,
    AIIO_WIFI_EVENT_BEACON_IND_AUTH_WPA3_ENTERPRISE,
...
typedef enum {
    AIIO_WIFI_EAP_TYPE_DISABLE=0,    //没有连接，或者已经断开
    AIIO_WIFI_EAP_TYPE_PEAP=1,   //PEAP认证
    AIIO_WIFI_EAP_TYPE_TLS=2,    //TLS认证
    AIIO_WIFI_EAP_TYPE_TTLS=3,   //TTLS认证
    AIIO_WIFI_EAP_TYPE_FAST=4,   //FAST认证
    AIIO_WIFI_EAP_TYPE_MAX
} aiio_wifi_eap_type;
...
typedef struct {
    ...
    uint8_t use_dhcp;
    aiio_wifi_eap_type eapType;
    char staIdentity[AIIO_WIFI_IDENTITY_SIZE];    /* EAP username*/
...
/*Only support BL602*/
CHIP_API int aiio_wifi_sta_ipv6_get(uint8_t index, ip_addr_t *ip6addr, uint8_t *state);

/** @brief  Set wifi hostname.
 *  @param[in] hostname wifi hostname.
 *  @return             Return the operation status. When the return value is AIIO_OK, the unregister is successful.
 *  @retval             AIIO_OK         unregister successful.
 *  @retval             AIIO_ERROR      unregister error.
 *  @note
 *  @see
 */
CHIP_API aiio_err_t aiio_wifi_set_hostname(char *hostname);
