...
#ifndef _ALI_AIS_OS_H_
#define _ALI_AIS_OS_H_
 ...
 * @return  0: success.
 */
int ali_os_timer_new(os_timer_t *timer, os_timer_cb_t cb, void *arg, int ms);
 ...
 * @return  0: success.
 */
int ali_os_timer_start(os_timer_t *timer);
 ...
 * @return  0: success.
 */
int ali_os_timer_stop(os_timer_t *timer);
 ...
 */
void ali_os_timer_free(os_timer_t *timer);
...
int os_mutex_new(aiio_os_mutex_handle_t *mutex);

int os_mutex_lock(aiio_os_mutex_handle_t *mutex, unsigned int ms);

int os_mutex_unlock(aiio_os_mutex_handle_t *mutex);
