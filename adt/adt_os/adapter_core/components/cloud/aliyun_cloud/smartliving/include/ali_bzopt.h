...
#ifndef ALI_BREEZE_OPT_H
#define ALI_BREEZE_OPT_H
...
#else
#define BREEZE_FLOW                     aiio_log_i
#define BREEZE_DEBUG(format, args...)   aiio_log_i("[BZ]"format"\n", ##args)
#define BREEZE_INFO(format, args...)    aiio_log_i("[BZ]"format"\n", ##args)
#define BREEZE_WARN(format, args...)    aiio_log_i("[BZ]"format"\n", ##args)
#define BREEZE_ERR(format, args...)     aiio_log_i("[BZ]"format"\n", ##args)
#define BREEZE_FATAL         aiio_log_i
#define BREEZE_TRACE         aiio_log_i
#define BREEZE_EMERG         aiio_log_i
