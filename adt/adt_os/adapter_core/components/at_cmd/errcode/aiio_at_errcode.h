...
#define AIIO_AT_ERR_COM_READ_FAIL                        (AIIO_AT_ERR_COM_BASE + 2)
#define AIIO_AT_ERR_COM_WRITE_FAIL                       (AIIO_AT_ERR_COM_BASE + 3)
...
#define AIIO_AT_ERR_WIFI_CONNECT_TIMEOUT                 (AIIO_AT_ERR_WIFI_BASE + 13)
#define AIIO_AT_ERR_WIFI_CONNECT_PW_ERROR                (AIIO_AT_ERR_WIFI_BASE + 14)
#define AIIO_AT_ERR_WIFI_CONNECT_NOT_FOUND_AP            (AIIO_AT_ERR_WIFI_BASE + 15)
...
#define AIIO_AT_ERR_HTTP_RESPONSE_ERROR					 (AIIO_AT_ERR_HTTP_BASE + 1)
...
#define AIIO_AT_ERR_BLE_MAC_SET_UNSUPPORT                (AIIO_AT_ERR_BLE_BASE + 2)
#define AIIO_AT_ERR_BLE_STATE_INVALID                    (AIIO_AT_ERR_BLE_BASE + 3)
#define AIIO_AT_ERR_BLE_DISCONNECT_FAIL                  (AIIO_AT_ERR_BLE_BASE + 4)
#define AIIO_AT_ERR_BLE_MTU_SET_FAIL                     (AIIO_AT_ERR_BLE_BASE + 5)
#define AIIO_AT_ERR_BLE_SEND_FAIL                        (AIIO_AT_ERR_BLE_BASE + 6)
#define AIIO_AT_ERR_BLE_ADV_DATA_FAIL                    (AIIO_AT_ERR_BLE_BASE + 7)
#define AIIO_AT_ERR_BLE_ADV_STATE_FAIL                   (AIIO_AT_ERR_BLE_BASE + 8)
#define AIIO_AT_ERR_BLE_SCAN_NO_TARGET                   (AIIO_AT_ERR_BLE_BASE + 9)
#define AIIO_AT_ERR_BLE_CONNECT_FAIL                     (AIIO_AT_ERR_BLE_BASE + 10)
#define AIIO_AT_ERR_BLE_MTU_GET_FAIL                     (AIIO_AT_ERR_BLE_BASE + 11)
#define AIIO_AT_ERR_BLE_MAC_GET_FAIL                     (AIIO_AT_ERR_BLE_BASE + 12)
