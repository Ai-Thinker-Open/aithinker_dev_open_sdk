...
#define AI_COMBO_SDK_VERSION	"V4.18_P3.0.0"
...
#endif
#define AIIO_AT_TASK_STACK_SIZE     (1024*8)
...
#define AIIO_AT_CMD_TOKEN_LEN       512
...
typedef enum
{
    ...
    AIIO_AT_RET_SUCCESS = 0,    //自动打印OK
    AIIO_AT_RET_CUSTOM = 1,     //不打印OK
...
/** @brief Exit passthrough
 *
 *  @note
 *  @see
 */
CORE_API void exit_passthrough_mode(void);
