...
#define AIIO_BLUFI_ERROR GATT_ERROR
#define AIIO_BLUFI_SUCCESS GATT_SUCCESS
#else
#define AIIO_BLUFI_ERROR 0x85
#define AIIO_BLUFI_SUCCESS 0x00
#endif
...
typedef union {
    struct blufi_cfg_report {
        aiio_wifi_mode_t opmode;
        aiio_blufi_sta_conn_state_t sta_conn_state;
        uint8_t softap_conn_num;
        aiio_blufi_extra_info_t *extra_info;
        int32_t extra_info_len;
    } wifi_conn_report;
    /*
        BTC_BLUFI_ACT_SEND_WIFI_LIST
    */
    struct blufi_wifi_list {
        uint16_t apCount;
        aiio_blufi_ap_record_t *list;
    } wifi_list;
    /*
        BTC_BLUFI_ACT_SEND_ERR_INFO
    */
    struct blufi_error_infor {
        aiio_blufi_error_state_t state;
    } blufi_err_infor;
    /*
        BTC_BLUFI_ACT_SEND_CUSTOM_DATA
    */
...
void btc_blufi_cb_to_app(aiio_blufi_cb_event_t event, aiio_blufi_cb_param_t *param);
