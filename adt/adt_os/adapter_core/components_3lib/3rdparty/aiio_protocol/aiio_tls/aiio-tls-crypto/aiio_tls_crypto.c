...
#define _crypto_sha256 aiio_crypto_sha256_mbedtls
...
#ifdef CONFIG_TLS_USING_MBEDTLS
static int aiio_crypto_sha256_mbedtls( const unsigned char *input,
                                    size_t ilen,
...
int aiio_crypto_sha256( const unsigned char *input,
                     ...
                     unsigned char output[32])
{
    return _crypto_sha256(input, ilen, output);
}
