 ...
 */
#define CONFIG_TEST_PWM0_PORT AIIO_PWM_PORTB
#define CONFIG_BLE_DISTRIBUTION_NETWORK_ENABLE 1
#define CONFIG_WAN_NETWORK_ENABLE 1
#define CONFIG_TEST_PWM0 AIIO_GPIO_NUM_5
...
#define CONFIG_TEST_PWM1_PORT AIIO_PWM_PORTB
