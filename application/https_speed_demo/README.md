...
$ ./build.sh bl602 https_speed_demo menuconfig // 配置使用的平台IO信息以及log等级等

$ ./build.sh bl602 https_speed_demo cn debug // 编译对应的平台demo
```

demo 简介
```
固件路径:aithinker_dev_sdk/out/bl602(对应平台命名)/https_speed_demo/bin/dev_project.bin

功能:电脑上创建热点名为：myssid，密码为：mypasswd的热点
