...
#define CONFIG_AIIO_ADC_ONE_SHOT 1
...
#define CONFIG_AIIO_ADC_VREF_3_2_V 1
#define CONFIG_LOG_DEFAULT_LEVEL_INFO 1
#define CONFIG_lib1 1
#define CONFIG_ADC_MODE 0
...
#define CONFIG_AIIO_ADC_RESOLUTION_14 1
#define CONFIG_ADC_RESOLUTION 5
