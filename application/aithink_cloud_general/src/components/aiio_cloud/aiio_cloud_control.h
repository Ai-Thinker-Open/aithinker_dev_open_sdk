...
#define     AIIO_PROTOCOL_DATA_MAX_LEN           (1024)
...
/**
 * @brief   Save the mid and from from cloud/app, used before MCU attribute report
 *
 * @param[in]   mid     The message ID received from cloud/app
 * @param[in]   from    The source field received from cloud/app
 */
