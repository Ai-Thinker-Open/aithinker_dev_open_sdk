...
#define         DEVICE_FW_VERSION           ("1.2.9")                   /*!< The version of firmware，it will report to cloud，and show on APP*/
...
#define FLASH_RW_OTA_INFO_ADDR              (CONFIG_OTA_START_ADDR)
...
#define DEVICE_OTA_MODE_FLASH_BLOCK              "ota_mode"

#define IOT_OTA_TYPE_MODULE                     "module_ota_all"
#define IOT_OTA_TYPE_MCU                        "module_mcu_all"
#define IOT_OTA_TYPE_EXTEND                     "module_extend_all"
...
typedef struct 
{
    ...
    char    otaKey[64];                 /**< OTA key，拓展固件key*/
...
extern bool cloud_connect_flag;
extern xmodem_mode_t ota_transmit_mode;
extern bool model_ota_flag;
