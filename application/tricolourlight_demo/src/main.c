...
#define AIIO_GPIO_GREEN_PORT CONFIG_GPIO_GREEN_PORT
#define AIIO_GPIO_BLUE_PORT CONFIG_GPIO_BLUE_PORT
#define AIIO_GPIO_RED_PIN CONFIG_GPIO_RED_PIN
#define AIIO_GPIO_GREEN_PIN CONFIG_GPIO_GREEN_PIN
...
void aiio_tricolourlight_function(void)
{
    ...
    aiio_hal_gpio_init(AIIO_GPIO_GREEN_PORT, AIIO_GPIO_GREEN_PIN);
    ...
    aiio_hal_gpio_pin_direction_set(AIIO_GPIO_GREEN_PORT, AIIO_GPIO_GREEN_PIN, AIIO_GPIO_OUTPUT);
    ...
    while (1)
    {
        ...
        case 0:
            ...
            aiio_hal_gpio_set(AIIO_GPIO_GREEN_PORT, AIIO_GPIO_GREEN_PIN, 0);
        ...
        case 2:
            aiio_hal_gpio_set(AIIO_GPIO_RED_PORT, AIIO_GPIO_RED_PIN, 0);
            aiio_hal_gpio_set(AIIO_GPIO_GREEN_PORT, AIIO_GPIO_GREEN_PIN, 1);
            aiio_hal_gpio_set(AIIO_GPIO_BLUE_PORT, AIIO_GPIO_BLUE_PIN, 0);
            break;
        case 3:
            aiio_hal_gpio_set(AIIO_GPIO_RED_PORT, AIIO_GPIO_RED_PIN, 0);
