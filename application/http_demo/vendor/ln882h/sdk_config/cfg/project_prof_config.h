 ...
 ****************************************************************************************
 *
 * @file project_prof_config.h
 *
 * @brief config current project profile use.
 *
...
#ifndef _PROJECT_PROF_CONFIG_H_
#define _PROJECT_PROF_CONFIG_H_
/**
 ****************************************************************************************
 * @addtogroup APP
 *
 *
 * @brief config the profiles use in current porject.
 *
 * @{
 ****************************************************************************************
 */
...
//customer define server
//#define CFG_PRF_NETCFG
