...
```
$ ./build.sh 芯片型号 应用名称 menuconfig		 举例：./build.sh ln882h gpio_demo menuconfig
```

应用开发编译方法：

```
$ ./build.sh 芯片型号 应用名称 国家编码 调试等级	举例：./build.sh ln882h gpio_demo cn debug

```
demo 简介
```
固件路径:aithinker_dev_sdk/out/ln882h(对应平台命名)/gpio_demo/bin/dev_project.bin
