...
#define CONFIG_TEST_PORT_OUT AIIO_GPIO_B
#define CONFIG_RELIABILITY_TEST 1
#define CONFIG_TEST_PORT_INOUT AIIO_GPIO_B
#define CONFIG_BSP_USING_CONFIG 1
#define CONFIG_TEST_INOUT_GPIO AIIO_GPIO_NUM_4
#define CONFIG_LOG_COLORS 1
#define CONFIG_LOG_SET_LEVEL 1
#define CONFIG_GPIO_TEST 1
#define CONFIG_TEST_OUT_GPIO AIIO_GPIO_NUM_5
