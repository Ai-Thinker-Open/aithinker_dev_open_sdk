...
// #define GPIO_INOUT_TEST_PORT  AIIO_GPIO_A
// #define GPIO_INOUT_TEST_GPIO  AIIO_GPIO_NUM_13
// #define GPIO_OUT_TEST_PORT  CONFIG_TEST_PORT_OUT
// #define GPIO_OUT_TEST_GPIO  CONFIG_TEST_OUT_GPIO
...
void test_gpio_function(void *params)
{
    ...
    // aiio_hal_gpio_set(GPIO_INOUT_TEST_PORT, GPIO_INOUT_TEST_GPIO, 1);
    int j = 0, i=0;
    while (1)
    {
        if (i++ >= 30)
        {
            ...
            while (1 == aiio_hal_gpio_get(GPIO_INOUT_TEST_PORT, GPIO_INOUT_TEST_GPIO))
            {
...
void test_gpio_func(void)
{
    ...
    aiio_os_thread_create((aiio_os_thread_handle_t *)&aiio_gpio_thread, "test_gpio", (aiio_os_function_return_t)test_gpio_function, 4096, NULL, 3);
