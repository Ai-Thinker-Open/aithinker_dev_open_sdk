...
int jpeg_frame_push(jpeg_frame_t *jpeg_frame_info)
{
    ...
    if (jpeg_frame_info->frame_id < 0) {
        aiio_log_i("ERROR: jpeg push id invalid\r\n");
        return -1;
    }
    ...
    if (ret == pdTRUE) {
        ...
        aiio_log_i("ERROR: jpeg push queue full\r\n");
        return -2;
    }
}
...
int jpeg_frame_free(jpeg_frame_t *jpeg_frame_info)
{
    ...
    if (jpeg_frame_info->frame_id < 0) {
        aiio_log_i("ERROR: jpeg free id invalid\r\n");
        return -1;
    }
    ...
    if (ret == pdTRUE) {
        ...
        aiio_log_i("ERROR: jpeg free queue timeout\r\n");
        return -1;
    }
}
