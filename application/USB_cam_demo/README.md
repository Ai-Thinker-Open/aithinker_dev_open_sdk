...
$ ./build.sh bl618 USB_cam_demo menuconfig // 配置使用的平台IO信息以及log等级等

$ ./build.sh bl618 USB_cam_demo cn debug // 编译对应的平台demo
```

demo 简介
```
固件路径:aithinker_dev_sdk/out/bl618(对应平台命名)/USB_cam_demo/bin/dev_project.bin
