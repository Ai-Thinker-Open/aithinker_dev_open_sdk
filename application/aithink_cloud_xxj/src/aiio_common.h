...
#define FLASH_RW_DEVICE_STATUS_ADDR              (CONFIG_FLASH_RW_START_ADDR + CONFIG_FLASH_REGION_SIZE * 2)
#define FLASH_RW_OTA_INFO_ADDR              (CONFIG_FLASH_RW_START_ADDR + CONFIG_FLASH_REGION_SIZE * 3)
...
typedef struct
{
    bool switch_control;          /**< set xxj on or off */
    uint8_t work_mode;            /**< set xxj mode */
    uint8_t spray_size;             /**<set xxj spray size*/
}aiio_xxj_fun_t;
...
extern aiio_xxj_fun_t Fragrance;
extern bool device_switch_control;
extern AIIO_TIMER paring_led_timer_handle;
extern AIIO_TIMER mode_control_timer_handle;
extern aiio_rtc_time_t *current_rtc_time;
extern bool pwm_control;
extern bool reparing_flag;
extern bool paring_succ_flag;
