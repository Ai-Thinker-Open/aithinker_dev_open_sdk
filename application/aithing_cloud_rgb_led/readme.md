...
* menuconfig配置指令
  ...
  * BL602 menuconfig配置指令
    ...
    ```
     ./build.sh bl602 aithing_cloud_rgb_led menuconfig
    ```

  * BL618 menuconfig配置指令

    ```
     ./build.sh bl618 aithing_cloud_rgb_led menuconfig
    ```

  * BL616 menuconfig配置指令

    ```
     ./build.sh bl616 aithing_cloud_rgb_led menuconfig
    ```
...
* BL602固件编译
  ...
  ```
   ./build.sh bl602 aithing_cloud_rgb_led cn debug
  ```

* BL618固件编译

  ```
   ./build.sh bl618 aithing_cloud_rgb_led cn debug
  ```

* BL616固件编译

  ```
   ./build.sh bl616 aithing_cloud_rgb_led cn debug
  ```
