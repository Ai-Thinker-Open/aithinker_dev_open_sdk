...
# Platform adapter
bin_src_elf=$sdk_dir/examples/dev_project/build/build_out/dev_project_bl616.elf
bin_src_bin=$sdk_dir/examples/dev_project/build/build_out/dev_project_bl616.bin
bin_src_map=$sdk_dir/examples/dev_project/build/build_out/dev_project_bl616.map
