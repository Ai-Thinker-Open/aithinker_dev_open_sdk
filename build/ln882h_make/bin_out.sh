...
# Platform adapter
bin_src_elf=$sdk_dir/build-dev_project-release/bin/dev_project.elf
bin_src_bin=$sdk_dir/build-dev_project-release/bin/flashimage.bin
bin_src_map=$sdk_dir/build-dev_project-release/dev_project.map
