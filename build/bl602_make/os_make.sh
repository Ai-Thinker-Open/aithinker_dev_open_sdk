...
## Cp To SDK
rm -rf $sdk_dir/customer_app/dev_project && cp -a $application_tmp_app_dir $sdk_dir/customer_app/dev_project

## Make
cd $sdk_dir/customer_app/dev_project && ./genromap
