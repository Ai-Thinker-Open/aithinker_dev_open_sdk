...
echo "#ifndef ADT_OS_COMMIT_ID" >> $application_tmp_app_dir/src/aiio_autoconf.h
echo "#define ADT_OS_COMMIT_ID \"$adt_os_commit_id\"" >> $application_tmp_app_dir/src/aiio_autoconf.h
echo "#endif" >> $application_tmp_app_dir/src/aiio_autoconf.h

## Cp To SDK
rm -rf $sdk_dir/amebadplus_gcc_project/project_km4/src/dev_project && cp -a $application_tmp_app_dir $sdk_dir/amebadplus_gcc_project/project_km4/src/dev_project

## Make
rm -f $sdk_dir/amebadplus_gcc_project/km4_boot_all.bin $sdk_dir/amebadplus_gcc_project/km0_km4_app.bin
cd $sdk_dir/amebadplus_gcc_project && ./build.py
